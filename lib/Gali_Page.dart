...
class Gali_Page extends StatefulWidget {
  static final String id = "Gali_Page";

  const Gali_Page({super.key});

  @override
  State<Gali_Page> createState() => _Gali_PageState();
}

class  _Gali_PageState extends State<Gali_Page> {
